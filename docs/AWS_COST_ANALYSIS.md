...
*Note: AWS pricing varies by region. Prices shown are for us-east-1 and may change. Always check [AWS Pricing Calculator](https://calculator.aws/) for current rates.*
